			...
			DEFINE_OID(iso_us()+113549, rsadsi)
				DEFINE_OID(rsadsi()+1, pkcs)
					DEFINE_OID(pkcs()+1, pkcs_1)
						...
						DEFINE_OID(pkcs_1()+6, rsaOAEPEncryptionSET)
	...
	DEFINE_OID(iso()+3, identified_organization)
		...
		DEFINE_OID(identified_organization()+6, dod)
			DEFINE_OID(dod()+1, internet)
				...
				DEFINE_OID(internet()+5, security)
					DEFINE_OID(security()+5, mechanisms)
						DEFINE_OID(mechanisms()+7, pkix)
							DEFINE_OID(pkix()+48, ad)
								DEFINE_OID(ad()+1, ocsp)
									DEFINE_OID(ocsp()+1, basic_response)
									DEFINE_OID(ocsp()+2, nonce_extension)
									DEFINE_OID(ocsp()+3, crl)
